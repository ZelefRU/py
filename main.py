...
with open("final.xml", "w", encoding='utf-8') as file:
    file.write("<offers>\n")
    for line in lines:
        ...
        if price > 500000:
            ...
            longDelivery = 50000
            veryLongDelivery = 70000
        print(model, brand, day, "дней", price, "тг")
        ...
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP1\" preOrder=\"{day + 6}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP2\" preOrder=\"{day}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP3\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP4\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP5\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP6\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP7\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP8\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP9\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP10\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP11\" preOrder=\"{day + 4}\"/>\n")
        file.write(f"\t\t<availability available=\"yes\" storeId=\"PP12\" preOrder=\"{day + 6}\"/>\n")
